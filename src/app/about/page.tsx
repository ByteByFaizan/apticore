      ...
      <main>
        ...
        <section className="relative pt-28 pb-16 sm:pt-40 sm:pb-24 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] bg-[radial-gradient(ellipse_at_center,rgba(28,63,58,0.04),transparent)] rounded-full blur-3xl" />
          </div>
          <div className="absolute top-1/4 right-1/4 w-[300px] h-[300px] bg-[radial-gradient(ellipse_at_center,rgba(28,63,58,0.03),transparent)] rounded-full blur-2xl pointer-events-none animate-float-gentle" />

          <div className="relative max-w-[1100px] mx-auto px-4">
            <div className="flex flex-col items-center text-center gap-8">
              {/* Animated accent line */}
              <div className="w-[2px] h-16 bg-gradient-to-b from-transparent via-brand/30 to-brand/60 rounded-full animate-fade-in" />

              <h1 className="max-w-[720px] text-4xl sm:text-5xl md:text-[64px] font-extrabold leading-tight md:leading-[1.15] font-display animate-fade-in-up text-balance text-ink">
                Making hiring decisions you can actually{" "}
                <span className="bg-gradient-to-r from-accent via-brand to-accent-dark bg-clip-text text-transparent">
                  defend.
                </span>
              </h1>

              <p className="max-w-[560px] text-ink-light text-lg font-medium leading-7 animate-fade-in-up animation-delay-200">
            ...
            <RevealOnScroll>
              <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] md:gap-16 items-start">
                ...
                <div>
                  ...
                  <h2 className="mt-4 font-display text-3xl sm:text-4xl font-semibold leading-snug text-ink">
                ...
                <div className="relative">
                  <div className="border-l-[3px] border-brand/30 bg-white p-8 sm:p-10 shadow-[0_2px_16px_rgba(28,63,58,0.04)] md:mt-12">
                    <blockquote className="font-display text-xl sm:text-2xl leading-relaxed text-ink italic">
        ...
        {/* ━━━ Values ━━━ */}
        <section className="py-16 sm:py-24 border-t border-edge">
          <div className="max-w-[1100px] mx-auto px-4">
            <RevealOnScroll>
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {values.map((value, i) => (
                <RevealOnScroll key={value.title} delay={i * 120}>
                  <div className="group relative bg-white border border-edge/80 p-8 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-brand/15 hover:shadow-[0_12px_40px_rgba(28,63,58,0.07)] hover:-translate-y-1.5 cursor-default h-full overflow-hidden">
                    ...
                    <p className="relative mt-3 text-sm leading-[1.75] text-ink-light/85">
                      {value.description}
                    </p>
        ...
        <section className="py-16 sm:py-24">
          <div className="max-w-[1100px] mx-auto px-4">
            <RevealOnScroll>
              <div className="relative bg-brand text-white p-10 sm:p-16 overflow-hidden">
                {/* Decorative corners */}
                ...
                {/* Dot textures */}
                <div
                  className="absolute top-6 right-6 w-32 h-32 pointer-events-none opacity-60"
                  style={{
                ...
                />
                <div
                  className="absolute bottom-8 right-1/4 w-24 h-24 pointer-events-none opacity-40"
                  style={{
                ...
                <div className="relative max-w-[640px]">
                  ...
                  <h2 className="mt-4 font-display text-3xl sm:text-4xl font-semibold leading-snug text-white">
          ...
          <div className="max-w-[1100px] mx-auto px-4">
            ...
            <div className="grid gap-8 sm:grid-cols-2 max-w-[680px] mx-auto">
              {[
                ...
                <RevealOnScroll key={member.name} delay={i * 120}>
                  <a
                    href={`https://github.com/${member.github}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex flex-col items-center bg-white border border-edge/80 p-8 sm:p-10 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-brand/15 hover:shadow-[0_12px_40px_rgba(28,63,58,0.07)] hover:-translate-y-1.5 cursor-pointer relative overflow-hidden"
                  >
                    {/* Bottom accent line */}
                    <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-brand to-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] origin-left" />

                    <div className="relative w-32 h-32 rounded-full overflow-hidden border-[3px] border-edge group-hover:border-brand/30 transition-all duration-500 group-hover:scale-105">
                      <Image
                    ...
                    <p className="mt-1.5 inline-block text-[11px] font-semibold text-ink-muted uppercase tracking-[0.12em] bg-surface-alt px-3 py-1 rounded-full">
                      {member.role}
                    </p>

                    <div className="mt-4 inline-flex items-center gap-1.5 text-xs font-medium text-ink-faint group-hover:text-brand transition-colors duration-300">
        ...
        {/* ━━━ CTA ━━━ */}
        <section className="relative py-16 sm:py-20 border-t border-b border-edge bg-surface-alt overflow-hidden">
          {/* Floating orbs */}
          <div className="absolute -top-20 -right-20 w-[300px] h-[300px] bg-[radial-gradient(ellipse_at_center,rgba(28,63,58,0.04),transparent)] rounded-full blur-2xl pointer-events-none animate-float-gentle" />
          <div className="absolute -bottom-20 -left-20 w-[250px] h-[250px] bg-[radial-gradient(ellipse_at_center,rgba(28,63,58,0.03),transparent)] rounded-full blur-2xl pointer-events-none animate-float-gentle animation-delay-300" />

          <div className="relative max-w-[1100px] mx-auto px-4 text-center">
            <RevealOnScroll>
              <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-semibold leading-tight tracking-tight text-ink">
                Ready to make hiring fair?
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-base text-ink-light sm:text-lg font-medium leading-7">
