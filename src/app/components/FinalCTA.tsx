...
export default function FinalCTA() {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative py-20 sm:py-28 border-t border-b border-brand/12 overflow-hidden"
    ...
    >
      ...
      <div
        data-orb
        className="absolute -top-16 -right-16 w-[300px] h-[300px] bg-gradient-radial from-accent/20 to-transparent rounded-full blur-2xl pointer-events-none transition-transform duration-[1200ms] ease-out"
      />
      <div
        data-orb
        className="absolute -bottom-16 -left-16 w-[250px] h-[250px] bg-gradient-radial from-emerald/15 to-transparent rounded-full blur-2xl pointer-events-none transition-transform duration-[1200ms] ease-out"
      />
      <div
        data-orb
        className="absolute top-1/3 left-1/3 w-[180px] h-[180px] bg-gradient-radial from-white/[0.04] to-transparent rounded-full blur-xl pointer-events-none transition-transform duration-[1200ms] ease-out"
      />

      <div className="relative max-w-[1100px] mx-auto px-4 text-center">
        <RevealOnScroll>
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight text-white">
            Ready to Make Hiring Fair?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base text-white/70 sm:text-lg font-medium leading-7">
