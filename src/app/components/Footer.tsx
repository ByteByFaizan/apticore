          ...
          <div className="flex items-center gap-3">
            ...
            {[
              ...
              <a
                key={social.label}
                href={social.href}
                className="w-8 h-8 rounded-full bg-surface-alt flex items-center justify-center text-ink-muted hover:bg-brand hover:text-white transition-all duration-300"
